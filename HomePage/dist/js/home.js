$(function() {
    ...
    tweenA = new TimelineMax ()
       .add([
           TweenMax.fromTo("#sun-burst", 3, {  y: "0", scale: 1.5, transformOrigin:"50% 50%" }, { y: "-=50", scale: 1, ease: Linear.easeNone }),
           TweenMax.fromTo("#cloud-1", 3, { y: 0,  scale: 1.2,  transformOrigin:"50% 50%" }, { y: "+=60", ease: Linear.easeNone }),
